...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow fixed-top" style="padding:10px 20px">
    ...
    <a class="navbar-brand"><img style="width:12%"  src="assets/tilogo.png" alt="logo"></a> </nav>
<section class="section" style="margin-top: 84px;">
    <div class="container indexPage">
        <div class="row firstPage">
            <div class="indexColum">
                <h1>Twitter Inspector</h1>
                <p>Inspect your social media platforms content and build your business</p>
